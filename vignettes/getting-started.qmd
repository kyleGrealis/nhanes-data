...
# Filter to adults with valid BMI and gender data
adults_bmi <- bmi_data |>
  filter(
...
# Calculate mean BMI for each year and gender combination
# group_by() groups data by year and gender
# summarize() calculates statistics for each group
bmi_summary <- adults_bmi |>
...
- The same `seqn` value can appear in different years if someone participated multiple times
